...
-(void)viewDidLoad {
    ...
    NSAttributedString* subHeader = [[NSAttributedString alloc] initWithString:@"By UBC and Steamclock Software\n\n" attributes:@{NSFontAttributeName : subHeadline}];
    NSAttributedString* content = [[NSAttributedString alloc] initWithString:@"Space is an experimental note board with the ability to jot down thoughts and plans, arrange them, and discard them once they are complete." attributes:@{NSFontAttributeName : body}];
